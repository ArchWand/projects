...
bool localizedCheckExists(const int & x, const int & y, const int & cx, const int & cy, char* board, const std::vector<std::vector<std::pair<std::string, std::vector<int> > > > & badsByLetter) {
	...
	for(int i = 0; i < int(badsByLetter[tolower(board[cx*y+cy])].size()); i++) {

		for(int q = 0; q < int(badsByLetter[tolower(board[cx*y+cy])][i].second.size()); q++) {
			right = cx-badsByLetter[tolower(board[cx*y+cy])][i].second[q] >= 0 && cx+int(badsByLetter[tolower(board[cx*y+cy])][i].first.size())-badsByLetter[tolower(board[cx*y+cy])][i].second[q] <= x;
			left = cx+badsByLetter[tolower(board[cx*y+cy])][i].second[q] < x && cx-int(badsByLetter[tolower(board[cx*y+cy])][i].first.size())+badsByLetter[tolower(board[cx*y+cy])][i].second[q] >= -1;
			up = cy-badsByLetter[tolower(board[cx*y+cy])][i].second[q] >= 0 && cy+int(badsByLetter[tolower(board[cx*y+cy])][i].first.size())-badsByLetter[tolower(board[cx*y+cy])][i].second[q] <= y;
			down = cy+badsByLetter[tolower(board[cx*y+cy])][i].second[q] < y && cy-int(badsByLetter[tolower(board[cx*y+cy])][i].first.size())+badsByLetter[tolower(board[cx*y+cy])][i].second[q] >= -1;
			ur = up && right;
			ul = up && left;
			dr = down && right;
			dl = down && left;
			...
			for(int z = 0; z < int(badsByLetter[tolower(board[cx*y+cy])][i].first.size()); z++) {
				right = right && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy]);
				left = left && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy]);
				up = up && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx)*y+cy+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
				down = down && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx)*y+cy-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
				ur = ur && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
				ul = ul && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
				dr = dr && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx+(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
				dl = dl && badsByLetter[tolower(board[cx*y+cy])][i].first.at(z) == tolower(board[(cx-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q]))*y+cy-(z-badsByLetter[tolower(board[cx*y+cy])][i].second[q])]);
			}
		...
		while(true) {
			...
			if(goodBoard){
				...
				for(int j = 0; j < y; j++) {
					temp += "  ";
					for(int i = 0; i < x; i++) {
						temp+=tolower(board[(x-i-1)*y+y-j-1]);
					}
					temp += "\n";
				}
				solutions.insert(temp);
